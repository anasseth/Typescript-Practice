...
function currencyConverterApp() {
    return __awaiter(this, void 0, void 0, function () {
        var baseCurrency, rates, userInput, fromCurrency, toCurrency, amount, numericAmount, convertedAmount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Welcome to Currency Converter App');
                    baseCurrency = 'USD';
                    return [4 /*yield*/, utils_1.getExchangeRates(baseCurrency)];
                case 1:
                    rates = _a.sent();
                    if (!rates) {
                        return [2 /*return*/];
                ...
                case 2:
                    userInput = _a.sent();
                    fromCurrency = userInput.fromCurrency, toCurrency = userInput.toCurrency, amount = userInput.amount;
                    ...
                    convertedAmount = utils_1.convertCurrency(numericAmount, fromCurrency.toUpperCase(), toCurrency.toUpperCase(), rates);
