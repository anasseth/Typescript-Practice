...
var API_KEY = 'f2c6f846a55b72674c464b5b1748d666';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1["default"].get(BASE_URL + "?base=" + baseCurrency)];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.data.rates];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching exchange rates:', error_1.message);
